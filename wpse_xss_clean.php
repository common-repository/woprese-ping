...
class CI_Input {
	...
	*/
	...
	{
		//echo 'ji';
		//wpse_log_message('debug', "Input Class Initialized");
	...
	*/
	function _sanitize_globals()
	{
		...
		//wpse_log_message('debug', "Global POST and COOKIE data sanitized");
	}
	// --------------------------------------------------------------------
	/**
	* Clean Input Data
	...
	*/
	...
	//	echo '<br>remove_invisible_characters'.$str.'<br>';
		...
		*/
		...
		//wpse_log_message('debug', "XSS Filtering completed");
		return $str;
	}
	// --------------------------------------------------------------------
	/**
